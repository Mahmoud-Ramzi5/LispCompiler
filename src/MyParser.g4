...
LPAR DECLARE LPAR SPECIAL SYMBOL RPAR RPAR | LPAR DECLARE LPAR TYPE DATATYPES SYMBOL RPAR RPAR;
local_variable : LET LPAR binding_list RPAR | LET_STAR LPAR binding_list RPAR | SETQ (value|SYMBOL list)+|DECLARE LPAR TYPE DATATYPES SYMBOL RPAR;
