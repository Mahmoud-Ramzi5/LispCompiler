...
inline_function : LPAR DECLARE LPAR INLINE (VAR|SYMBOL) RPAR RPAR;
...
value : STRING | INT ;
binding_list : LPAR SYMBOL value RPAR (binding_list)?;
global_variable : LPAR DEFPARAMETER SYMBOL value STRING? RPAR | LPAR DEFVAR SYMBOL value STRING? RPAR | LPAR SETQ (value|SYMBOL list)+ RPAR |
LPAR DECLARE LPAR SPECIAL SYMBOL+ RPAR RPAR | LPAR DECLARE LPAR TYPE DATATYPES SYMBOL+ RPAR RPAR|LPAR DECLARE (LPAR TYPE DATATYPES SYMBOL RPAR)+ RPAR;
local_variable : LET LPAR binding_list RPAR | LET_STAR LPAR binding_list RPAR | SETQ (value|SYMBOL list)+|DECLARE LPAR TYPE DATATYPES SYMBOL+ RPAR|DECLARE (LPAR TYPE DATATYPES SYMBOL RPAR)+;
